...
import { Categories, Product, SubCategories } from 'src/app/Models/product.model';
...
export class AddProductComponent implements OnInit {
  ...
  constructor(private _productservice:ProductService,private _categoryservice:CategoryService,private fb: FormBuilder) { }
  ...
  ngOnInit(): void {
    ...
    this._categoryservice.getSubCategories().subscribe(
